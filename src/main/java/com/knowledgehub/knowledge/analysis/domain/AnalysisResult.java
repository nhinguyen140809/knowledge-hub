...
/**
 * What a {@link LanguageAnalyzer} produces for one artifact: the chunks plus any code entities
 * extracted alongside them. Document analyzers return no entities.
 *
 ...
 */
public record AnalysisResult(List<Chunk> chunks, List<CodeEntity> codeEntities) {
  ...
  public static AnalysisResult ofChunks(List<Chunk> chunks) {
    return new AnalysisResult(chunks, List.of());
  }
}
