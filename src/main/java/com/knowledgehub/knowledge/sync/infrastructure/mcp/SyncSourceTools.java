...
/**
 * MCP tool letting an agent bring a source's index up to date before querying. It is an inbound
 * adapter over the same {@link SyncService} the REST controller calls — no sync logic lives here.
 * The call is idempotent: re-syncing an unchanged source is a no-op.
 *
