 ...
 * inheritance). One implementation per language, picked by {@link #supports(RawArtifact)} — adding
 * a language is a new implementation, never a change here. Targets are already resolved to entity
 * ids, so the returned relationships are ready to write with confidence 1.
 */
