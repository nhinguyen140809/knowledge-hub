 ...
 * domain invariant (e.g. {@code DuplicateSourceException}) lives in {@code domain.exception} — the
 * domain model itself "knows" a duplicate is invalid, but only the application service "knows" a
