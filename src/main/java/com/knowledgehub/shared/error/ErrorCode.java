 ...
 * every {@link org.springframework.http.ProblemDetail} response (FR-5.4). Each value pairs a code
 * name with its HTTP status and a default human-readable message.
 *
 ...
 * — the service is internal/agent-facing and has no i18n requirement. See {@code
 * docs/plan/00-foundation-and-schema.md} §7.
 */
