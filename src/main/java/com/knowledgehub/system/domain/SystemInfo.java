 ...
 * @param vectorStoreMode the active vector store mode ({@code neo4j} or {@code neo4j+qdrant})
 */
public record SystemInfo(
    String application, String version, List<String> activeProfiles, String vectorStoreMode) {}
