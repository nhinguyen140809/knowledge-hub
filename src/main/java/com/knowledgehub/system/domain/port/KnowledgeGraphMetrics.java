 ...
 * deliberately excludes access-control (Principal, Credential) and system-metadata (SystemConfig,
 * SystemSettings) nodes, a different concern from "how big is the knowledge base".
 */
