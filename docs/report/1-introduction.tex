...
\begin{itemize}
  ...
  \item Xây dựng pipeline ingestion: chia dữ liệu thành các chunk (theo AST đối với mã nguồn, theo cấu trúc đối với tài liệu), sinh embedding, rồi xây dựng Knowledge Graph biểu diễn quan hệ giữa các entity (ví dụ: một hàm gọi một hàm khác, một yêu cầu được hiện thực bởi một đoạn code).
