...
\begin{itemize}
  ...
  \item \textbf{FR-2.3} Hệ thống phải xây dựng Knowledge Graph gồm các entity và quan hệ giữa chúng (theo FR-3). Entity gồm: các entity mã nguồn theo các mức ở FR-3.4, cùng các entity phi mã nguồn là tài liệu, requirement (SRS) và commit.
...
Các requirement FR-8.2 - 8.13 dựa trên mô hình hai bước:
\begin{itemize}
